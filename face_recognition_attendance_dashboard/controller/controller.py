    ...
    while True:
        ...
        if recognition == 1:
            ...
            for face_encoding in face_encodings:
                ...
                if face_distances[best_match_index] <= 40 and matches[best_match_index]:
                    name = known_face_names[best_match_index]
                    students, student_attendance = get_class_attendance(
                        selected_date=datetime.today().strftime("%Y-%m-%d")
                    )
                    if not student_attendance.get(name):
                        class_ref.child("attendance").child(
...
def view_student(student_id):
    ...
    if request.method == "POST":
        ...
        if request.form.get("_method") == "POST":
            ...
            file_name = f"D:/GitHub/IOT/face_recognition_attendance_dashboard/imgs/student/{student_id}.jpg"
            ...
            img_file_name = f"D:/GitHub/IOT/face_recognition_attendance_dashboard/imgs/student/{student_id}.jpg"
